  ...
  return (
    <section id="skills" className="py-24 bg-hacker-darker relative">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-mono text-hacker-green mb-12 text-center glitch-effect" data-text="Skills">
          Skills
        </h2>
        ...
        <div ref={ref} className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-hacker-dark border border-hacker-grey rounded-lg p-6">
              <h3 className="text-2xl font-mono text-hacker-cyan mb-6 text-center">Frontend</h3>
              <motion.div
                  ...
                  .map((skill, index) => (
                    <motion.div key={index} variants={itemVariants}>
                      <div className="flex justify-between mb-2">
                        ...
                        <span className="text-hacker-green">{skill.level}%</span>
                      </div>
            ...
            {/* Mobile Skills */}
            <div className="bg-hacker-dark border border-hacker-grey rounded-lg p-6">
              <h3 className="text-2xl font-mono text-hacker-cyan mb-6 text-center">Mobile</h3>
              <motion.div
                variants={containerVariants}
                initial="hidden"
                animate={controls}
            ...
            {/* DevOps Skills */}
            <div className="bg-hacker-dark border border-hacker-grey rounded-lg p-6">
              <h3 className="text-2xl font-mono text-hacker-cyan mb-6 text-center">DevOps</h3>
              <motion.div
                variants={containerVariants}
                initial="hidden"
                animate={controls}
